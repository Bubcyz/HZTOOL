...
def banner(console):
    ...
    brand_name =  "    __  _______      __________  ____  __\n"
    brand_name += "   / / / /__  /     /_  __/ __ \/ __ \/ / \n"
    brand_name += "  / /_/ /  / /       / / / / / / / / / /\n"
    brand_name += " / __  /  / /__     / / / /_/ / /_/ / /___\n"
    brand_name += "/_/ /_/  /____/    /_/  \____/\____/_____/\n"
    brand_name += "\n"
    brand_name += "\n"
    brand_name += " [ Powered By Omni Cylo ]\n"
    colors = [
...
if __name__ == "__main__":
    ...
    while True:
        ...
        while True:
            ...
            print(Colorate.Horizontal(Colors.rainbow, '{27}: Auto Inner 414hp         2.5k'))
